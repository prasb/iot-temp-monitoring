...
const FusePageCardedDashboard = forwardRef((props, ref) => {
...
FusePageCardedDashboard.propTypes = {
...
FusePageCardedDashboard.defaultProps = {};

export default memo(FusePageCardedDashboard);
